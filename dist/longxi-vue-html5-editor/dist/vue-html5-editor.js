/**
 * Vue-html5-editor 2.3.11
 * git+https://github.com/PeakTai/vue-html5-editor.git
 * build at Sat Dec 01 2018 09:59:56 GMT+0800 (GMT+08:00)
 */
...
var template$7 = "<div class=\"edit-select-card\"> <table> <tbody> <tr v-for=\"(tr, y) in 10\" :key=\"'tr' + y\" style=\"user-select: none;\"> <td v-for=\"(td, x) in 10\" :key=\"'td' + x\" @click=\"insertTable()\" @mouseover=\"hoverTd(x, y)\" style=\"user-select: none;\"> <div :class=\"{'table-card-selected': y < rows && x < cols}\" class=\"table-card\"></div> </td> </tr> </tbody> </table></div> ";
